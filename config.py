...
misc_arg.add_argument('--input_size', type=int, default = 1200, 
# misc_arg.add_argument('--input_size', type=int, default = 2600, 
                      help='multiplies of 256 by the structure of the model') 
misc_arg.add_argument('--use_network', type=bool, default = False)
misc_arg.add_argument('--use_filter', type=bool, default = True)
...
train_arg.add_argument('--feature', type=str, default = "ECG1",
                       help='ECG1 or ECG2')
...
predict_arg.add_argument('--sample_rate', type=int, default = 250)
predict_arg.add_argument('--sample_heartbeat', type=int, default = 6) #rr interval will always be sample_heartheat - 1)
